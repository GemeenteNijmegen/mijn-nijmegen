...
| 3 — Page bodies | [10 — Producten](./10-page-producten.md) | 04b | ✅ Done |
| 3 — Page bodies | [11 — Zaken](./11-page-zaken.md) | 04b | ✅ Done |
| 4 — Cleanup | [12 — Tighten CSP + dead CSS + side-nav](./12-cleanup-remove-legacy-tighten-csp.md) | 05–11 all done | ✅ Done |
